          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col justify-center relative z-20 mt-8 md:mt-0">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  href="/placards"
                  className="inline-flex items-center justify-center px-6 py-3 md:py-2.5 border border-gray-300 bg-white/80 text-gray-800 rounded-lg hover:bg-white transition-colors w-fit text-base md:text-sm"
                >
                  Airport Placards
                </Link>
              </div>
